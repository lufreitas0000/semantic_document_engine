...
% TODO: Explain Alembic's role in tracking database schema changes over time (version control for databases).

\subsubsection*{3. Vector Mathematics via \texttt{pgvector}}
% TODO: Explain the pgvector C-extension for PostgreSQL.
